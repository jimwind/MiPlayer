                      ...
                      uint8_t *saturationWarning)
{
    ...
    *saturationWarning = 0;
    //_TODO: PUT IN RANGE CHECKING FOR INPUT LEVELS
    *outMicLevel = inMicLevel;
    inMicLevelTmp = inMicLevel;

    // _TODO(andrew): clearly we don't need input and output pointers...
                   ...
                   int16_t agcMode, uint32_t fs)
{
    ...
    // (bjornv): Investigate if we really need to scale up a small range now when we have
