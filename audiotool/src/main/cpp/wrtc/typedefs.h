...
// _TODO(ajm): We'd prefer to control platform defines here, but this is
// currently provided by the Android makefiles. Commented to avoid duplicate
// definition warnings.
//#define WEBRTC_ARCH_ARM
// _TODO(ajm): Chromium uses the following two defines. Should we switch?
...
// _TODO(ajm): Hack to avoid multiple definitions until the base/ of webrtc and
