                  ...
                  FLOAT energy[4], int blocktype_d[2])
{
    ...
    /* LONG BLOCK CASE */
    {
        ...
        /* _TODO: apply adaptive ATH masking here ?? */
        for (chn = 0; chn < n_chn_psy; chn++) {
...
psymodel_init(lame_global_flags const *gfp)
{
    ...
    for (i = 0; i < gd->l.npart; i++) {
        ...
        /* _FIXME: it does work to reduce low-freq problems in S53-Wind-Sax
           and lead-voice samples, but introduces some 3 kbps bit bloat too.
           _TODO: Further refinement of the shape of this hack.
         */
